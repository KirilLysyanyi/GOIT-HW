...
users = [
    ...
    {"name": "Lex Lutor", "birthday": "1976.12.31"},
    {"name": "Freddy Cruger", "birthday": "1984.03.13"},
    {"name": "Ana De Armas", "birthday": "1988.04.30"},
    {"name": "Stan Smith", "birthday": "1980.03.13"}
]
...
upcoming_birthdays = get_upcoming_birthdays(prepare_users(users))
